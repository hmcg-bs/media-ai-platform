...
- Automated taxonomy admission now requires lower-confidence-bound precision and recall gates;
  classifier-only rows cannot support subcategory conclusions
